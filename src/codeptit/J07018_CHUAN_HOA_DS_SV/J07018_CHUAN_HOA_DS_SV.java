package codeptit.J07018_CHUAN_HOA_DS_SV;
...
public class J07018_CHUAN_HOA_DS_SV {
    public static void main(String[] args) throws FileNotFoundException {
        Scanner scanner = new Scanner(new FileInputStream("SINHVIEN.in"));
        int t = Integer.parseInt(scanner.nextLine());
        List<Student> students = new ArrayList<>();
        for (int i = 0; i < t; i++) {
            students.add(new Student(i + 1, scanner.nextLine(), scanner.nextLine(), scanner.nextLine(), Float.parseFloat(scanner.nextLine())));
        }
...
class Student{
    ...
    public String toString(){
        return getId() + " " + getName() + " " + className + " " + getDob()+ " " + String.format("%.2f", getGpa());
    }
}