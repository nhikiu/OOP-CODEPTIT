package codeptit.J05013_TUYEN_DUNG;
...
class Person{
    ...
    public double getPointA() {
        if (pointA > 10) return pointA /= 10;
        return pointA;
    }

    public double getPointB() {
        if (pointB > 10) return pointB /= 10;
        return pointB;
    }
    ...
    public String getStatus(){
        ...
        if (getTotalPoint() < 8) return "CAN NHAC";
        if (getTotalPoint() <= 9.5) return "DAT";
        return "XUAT SAC";
    }
